...
public class Selpracon_fb1 {
	...
	public void test() {
		...
		//this changes driver to alert mode and get alert text
	...
	public void test1() {
		...
		//when we testing it helps to kill all notepad pages automatically
		driver.get("http://google.com");
		Set<Cookie> cookie_names = driver.manage().getCookies();
			// get all cookies													
